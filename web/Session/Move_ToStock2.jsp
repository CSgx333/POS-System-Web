...
<% 
        ...
        String sub_amount = request.getParameter("amount");
        ...
        Class.forName("com.mysql.jdbc.Driver").newInstance();
         ...
         r4.next();
         int amount = Integer.parseInt(r4.getString("amount")) + Integer.parseInt(sub_amount);   
        ...
        String sql2 = "DELETE FROM suborder WHERE sub_id="+sub_id;
         ...
         setTimeout(function() {
             swal({
                ...
                type: "success"
                 ...
                 window.location = "http://localhost:8080/WebPOSSystem/Supplier.jsp";
             });
         }, 100);
</script>

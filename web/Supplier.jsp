                ...
                <div class="mainbox">
                    <div class="cardHeader">
                        ...
                        <form method="post" action="Supplier.jsp">
                         ...
                         <a href="AddSubOrder.jsp" class="btn2">Add Order</a>
                    </div>
                    ...
                    <%
                        ...
                        String Sqlid = "Select * from suborder";
                        if(id != null){
                             Sqlid = "Select * from suborder where sub_id='"+Integer.parseInt(id)+"'";
                        };
                    ...
                    <%
                        while (r.next()) {
                    %>
                            <form method="post" action="Session/Move_ToStock2.jsp">
                                <tr>
                                    <td><input hidden type="text" name="sub_id" value="<%=r.getString("sub_id")%>"><%=r.getString("sub_id")%></td>
                                   ...
                                   %>
                                    ...
                                    <td><input type="submit" class="button3" value="Move To Stock"></input></td>
                                </tr>
                            </form>

            ...
            <div class="details">
                <div class="mainbox">
                    <div class="cardHeader">
                        ...
                        <form method="post" action="Session/Add_Expense.jsp">
                          <div class="user-details">
                                <div class="input-box">
                                    <span class="txt-details">Expense ID</span>
                                    <input type="text" name="e_id" value="" placeholder="รหัสรายจ่าย" required>
                                </div>
                                <div class="input-box">
                                    <span class="txt-details">Expense Name</span>
                                    <input type="text" name="e_name" value="" placeholder="ชื่อรายจ่าย" required>
                                </div>
                                <div class="input-box">
                                    <span class="txt-details">Price</span>
                                    <input type="text" name="price" value="" placeholder="ราคา" required>
                                </div>
                          </div>  

            ...
            <div class="details">
                <div class="mainbox">
                    <div class="cardHeader">
                        ...
                        <form method="post" action="Session/Add_SubOrder.jsp">
                          <div class="user-details">
                                <div class="input-box">
                                    <span class="txt-details">SubOrder ID</span>
                                    <input type="text" name="sub_id" value="" placeholder="รหัสใบสั่งซื้อ" required>
                                </div>
                                <div class="input-box">
                                    <span class="txt-details">Product ID</span>
                                    <input type="text" name="p_id" value="" placeholder="รหัสสินค้า" required>
                                </div>
                                <div class="input-box">
                                ...
                                <div class="input-box">
                                 ...
                                 <div class="input-box">
                                    ...
                                    <input type="text" id="price" name="price" value="0.0" placeholder="ราคา ฿" required>
                                </div>
                                 <div class="input-box">
                                    <span class="txt-details">Amount</span>
                                    <input type="text" id="amount" name="amount" value="0" placeholder="จำนวน" required>
                                </div>
                                 <div class="input-box">
                                    <span class="txt-details">Total Price</span>
                                    <input type="text" id="total_price"  name="total_price" value="0.0" placeholder="ราคารวม" required>
                                </div>
                          </div>  

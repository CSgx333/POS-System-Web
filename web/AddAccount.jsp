            ...
            <div class="details">
                <div class="mainbox">
                    <div class="cardHeader">
                        ...
                        <form method="post" action="Session/Add_Account.jsp">
                          <div class="user-details">
                                <div class="input-box">
                                    <span class="txt-details">Account ID</span>
                                    <input type="text" name="id" value="" placeholder="รหัสบัญชี" required>
                                </div>
                                <div class="input-box">
                                    <span class="txt-details">Username</span>
                                    <input type="text" name="uname" value="" placeholder="ชื่อผู้ใช้" required>
                                </div>
                                <div class="input-box">
                                    <span class="txt-details">Password</span>
                                    <input type="text" name="password" value="" placeholder="รหัสผ่าน" required>
                                </div>
                          </div>  

                ...
                <div class="mainbox">
                    <div class="cardHeader">
                        ...
                        <form method="post" action="Expense.jsp">
                         ...
                         <a href="AddExpense.jsp" class="btn2">Add Expense</a>
                    </div>
                    ...
                    <%
                        ...
                        String Sqlid = "Select * from expense";
                        if(id != null){
                             Sqlid = "Select * from expense where e_id='"+Integer.parseInt(id)+"'";
                        };
                    ...
                    <%
                        while (r.next()) {
                    %>
                            <form method="post" action="Session/Payment.jsp">
                                <tr>
                                    <td><input hidden type="text" name="e_id" value="<%=r.getString("e_id")%>"><%=r.getString("e_id")%></td>
                                    <td><%=r.getString("e_name")%></td>
                                    <td><input hidden type="text" name="price" value="<%=r.getString("price")%>"><%=r.getString("price")%></td>
                                    <td><input type="submit" class="button2" value="Payment"></input></td>
                                </tr>
                            </form>
